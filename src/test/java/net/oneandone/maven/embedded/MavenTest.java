...
public class MavenTest {
    ...
    private static final Artifact SNAPSHOT = new DefaultArtifact("net.oneandone.stool:main:3.4.6-SNAPSHOT");
    ...
    public void latestSnapshot()
        ...
        assertTrue(version, version.startsWith("3.4.6-"));
    ...
    public void latestVersionSnapshot() throws Exception {
        ...
        assertTrue(latest, latest.startsWith("3.4.6-"));
    ...
    public void nextVersionSnapshotCP() throws Exception {
        ...
        assertTrue(str, str.startsWith("3.4.6-"));
